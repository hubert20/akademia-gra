...
export const view = `
<div class="task-6 h-100">
    <div class="assertive-task d-flex flex-wrap h-100">
        <div class="left-sml-side-task d-flex">
            <div class="fact-info d-flex align-items-start flex-column gap-4 p-3" style="background: #E3F5FA;border-radius: 1rem;">
                ...
                <div class="p-3 text-start" style="font-size: 20px;color: #006FCC;line-height: 1.2;">
                    Asertywność to umiejętność mówienia tego, co naprawdę myślimy i czujemy - z szacunkiem do siebie i
                    innych.
                    Nie chodzi o bycie miłym za wszelką cenę - ale o to, by stawiać granice i dbać o siebie.
                </div>
                <img src="${characterNeutral}" alt="Postać" id="character" class="character-img align-self-center" style="max-height: 260px;" />
            </div>
        </div>
        <div class="right-big-side-task">
            <div class="question-box p-4">
                <div class="question-header mt-4 mb-3 d-flex align-items-center justify-content-center gap-2">
                ...
                <div class="pb-5">
                    <div class="options-wrapper row g-1 justify-content-center">
                        <div class="col-6 pe-3 pb-3">
                            <button class="option-btn" data-id="1">„Nie muszę mieć ochoty robić tego co robią
                                inni.”</button>
                        </div>
                        <div class="col-6 pb-3">
                            <button class="option-btn" data-id="2">„Zawsze muszę zgodzić się z tym co sądzi mój
                                najlepszy przyjaciel.”</button>
                        </div>
                        <div class="col-6 pe-3">
                            <button class="option-btn" data-id="3">„Mogę nie zgodzić się z opinią moich
                                bliskich.”</button>
                        </div>
                        <div class="col-6">
                            <button class="option-btn" data-id="4">„Moje zdanie jest mniej ważne od zdania
                                innych.”</button>
                        </div>
                    </div>
                </div>
                  <div class="feedback-wrap p-4">
